            ...
            <Container className="wide-container">
                <Row>
                    <Col md={2} style={{display: "flex", flexDirection: "column"}}>
                        <Link to="/mission" className="foot-link">Our Company</Link>
                        <Link to="/about" className="foot-link" style={{fontSize: "0.8em"}}>About</Link>
                        <Link to="/services" className="foot-link" style={{fontSize: "0.8em"}}>Services</Link>
                    </Col>
                    <Col md={2}>
